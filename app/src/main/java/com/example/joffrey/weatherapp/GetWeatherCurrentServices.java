...
public class GetWeatherCurrentServices extends IntentService {
    private static final String get_current_weather = "com.example.joffrey.weatherapp.action.GetWeatherCurrentServices";
    private static final String TAG = "GetWeatherCurrentServices";

    public GetWeatherCurrentServices() {
        super("GetWeatherCurrentServices");
    }

    public static void startActionWeather(Context context) {
        Intent intent = new Intent(context, GetWeatherCurrentServices.class);
        intent.setAction(get_current_weather);
    ...
    private void handleActionWeather() {
        ...
        LocalBroadcastManager.getInstance(this).sendBroadcast(new Intent(WeatherCurrentActivity.WEATHER_UPDATE));
    }
